    ...
    return (
        <>
            ...
            <div className="mobile-controls">
                <Button style={{ color: "#fff", backgroundColor: "#404156", paddingInline: 30, paddingBlock: 7 }} variant="contained" disabled>
                    Click map: 1st click = start, 2nd click = end (Ctrl+click to reset)
                </Button>
            </div>
